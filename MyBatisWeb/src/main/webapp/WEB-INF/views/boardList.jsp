...
<c:set var="signupmypage" value="${loginId==null ? 'SignUp' : 'Mypage' }" />
<c:set var="signupmypagelink" value="${loginId==null ? '/register/add' : '/' }" />
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<style type="text/css">
		* { box-sizing: border-box; margin: 0; padding: 0; font-family: "Noto Sans KR", sans=serif; }
		...
		.search-container { background-color: rgb(253,253,250); width: 100%; height: 110px; border: 1px solid #ddd;
												margin-top: 10px; margin-bottom: 30px; display: flex; justify-content: center; align-items: center; }
		...
		.search-button { width: 20%; height: 100%; background-color: rgb(22,22,22); color: rgb(209,209,209); 
			...
			<table>
				...
				<c:forEach var="boardDto" items="${list }">
					<tr>
						...
						<td class="title"><a href="<c:url value="/board/read${pr.sc.queryString }&bno=${boardDto.bno }" />">${boardDto.title }</a></td>
