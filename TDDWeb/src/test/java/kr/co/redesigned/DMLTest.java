...
public class DMLTest {
	...
	public void deleteUserTest() throws SQLException {
		...
		User user = new User("ezen4", "0111", "ezen4", "ezen4@gmail.com", new Date(), "fb", new Date());
